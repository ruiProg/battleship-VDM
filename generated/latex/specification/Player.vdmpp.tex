...
\hline
\hline
\hyperref[Player:17]{Player} & 17&100.0\% & 57 \\
\hline
\hyperref[addBoards:28]{addBoards} & 28&100.0\% & 24 \\
\hline
\hyperref[allShipsPlaced:43]{allShipsPlaced} & 43&100.0\% & 78 \\
\hline
\hyperref[clearData:52]{clearData} & 52&100.0\% & 5 \\
\hline
\hyperref[getName:25]{getName} & 25&100.0\% & 639 \\
\hline
\hyperref[printGameStatus:98]{printGameStatus} & 98&100.0\% & 57 \\
\hline
\hyperref[printInfo:88]{printInfo} & 88&100.0\% & 12 \\
\hline
\hyperref[printPlacementStatus:93]{printPlacementStatus} & 93&100.0\% & 72 \\
\hline
\hyperref[printTakeDown:109]{printTakeDown} & 109&100.0\% & 12 \\
\hline
\hyperref[printVictory:112]{printVictory} & 112&100.0\% & 1 \\
\hline
\hyperref[registerAttack:60]{registerAttack} & 60&100.0\% & 112 \\
\hline
\hyperref[registerResult:72]{registerResult} & 72&100.0\% & 76 \\
\hline
\hyperref[shipPlacement:36]{shipPlacement} & 36&100.0\% & 90 \\
\hline
\hyperref[startRounds:46]{startRounds} & 46&100.0\% & 12 \\
\hline
\hline
Player.vdmpp & & 100.0\% & 1247 \\
\hline
\end{longtable}
