...
(*@
\label{testCreateGame:5}
@*)
(*@
\label{testCreatePlayer:5}
@*)
(*@
\label{run:5}
@*)
...
\hline
\hline
\hyperref[TestGame:4]{TestGame} & 4&0.0\% & 0 \\
\hline
\hyperref[run:5]{run} & 5&0.0\% & 0 \\
\hline
\hyperref[testCreateBoard:5]{testCreateBoard} & 5&0.0\% & 0 \\
\hline
\hyperref[testCreateGame:5]{testCreateGame} & 5&22.7\% & 0 \\
\hline
\hyperref[testCreatePlayer:5]{testCreatePlayer} & 5&19.2\% & 0 \\
\hline
\hyperref[testEmplacement:21]{testEmplacement} & 21&15.8\% & 0 \\
\hline
\hyperref[testShipGuess:48]{testShipGuess} & 48&48.2\% & 0 \\
\hline
\hline
TestGame.vdmpp & & 35.1\% & 0 \\
\hline
\end{longtable}
