...
\hline
\hline
\hyperref[getShips:39]{getShips} & 39&100.0\% & 24 \\
\hline
\hyperref[run:9]{run} & 9&100.0\% & 8 \\
\hline
\hyperref[testColMap:11]{testColMap} & 11&100.0\% & 8 \\
\hline
\hyperref[testCreateBoard:4]{testCreateBoard} & 4&100.0\% & 8 \\
\hline
\hyperref[testEmptyBeforePlacement:25]{testEmptyBeforePlacement} & 25&100.0\% & 8 \\
\hline
\hyperref[testGetShips:39]{testGetShips} & 39&100.0\% & 6 \\
\hline
\hyperref[testPrints:64]{testPrints} & 64&100.0\% & 6 \\
\hline
\hyperref[testRegisterMove:46]{testRegisterMove} & 46&100.0\% & 6 \\
\hline
\hline
